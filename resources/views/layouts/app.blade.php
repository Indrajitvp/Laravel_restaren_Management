...
<body>
    <div id="app">
        ...
        <!-- Navbar & Hero Start -->
        <div class="w-100 position-relative p-0 pb-0 m-0">
    ...
    <!-- JavaScript Libraries (External CDN links stay same) -->
    <script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script>

    <!-- JavaScript Libraries (Local files through asset() and correct path asset/lib/...) -->
